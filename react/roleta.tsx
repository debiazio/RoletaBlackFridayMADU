...
const Roleta = () => {
  ...
  const prizes = [
    { code: 'BLACKBIN', title: 'Bin' },
    { code: 'BLACKMLT', title: 'Maleta Madubox' },
    { code: 'BLACKSACOLA', title: 'Sacola' },
    { code: 'BLACKFRETE50%', title: 'Desconto Frete 50%' },
    { code: 'BLACKCXA', title: 'Caixa Madubox' },
  ];

  // Regras de prêmios por data
const prizeRules: Record<string, { range: number[]; code: string }[]> = {
  '2025-11-10': [
    { range: [1, 1], code: 'BLACKMLT' },
    { range: [2, 5], code: 'BLACKBIN' },
    { range: [6, 11], code: 'BLACKCXA' },
    { range: [12, 17], code: 'BLACKSACOLA' },
    { range: [18, 19], code: 'BLACKFRETE50' },
  ],
  '2025-11-11': [
    { range: [1, 1], code: 'BLACKMLT' },
    { range: [2, 5], code: 'BLACKBIN' },
  ...
  '2025-11-19': [
    { range: [1, 1], code: 'BLACKMLT' },
    { range: [2, 7], code: 'BLACKBIN' },
    { range: [8, 13], code: 'BLACKCXA' },
    { range: [14, 19], code: 'BLACKSACOLA' },
    { range: [20, 21], code: 'BLACKFRETE50' },
  ],
  '2025-11-20': [
    { range: [1, 2], code: 'BLACKMLT' },
    { range: [3, 6], code: 'BLACKBIN' },
    { range: [7, 12], code: 'BLACKCXA' },
    { range: [13, 18], code: 'BLACKSACOLA' },
    { range: [19, 20], code: 'BLACKFRETE50' },
  ],
  '2025-11-21': [
    { range: [1, 2], code: 'BLACKMLT' },
    { range: [3, 8], code: 'BLACKBIN' },
    { range: [9, 14], code: 'BLACKCXA' },
    { range: [15, 20], code: 'BLACKSACOLA' },
    { range: [21, 22], code: 'BLACKFRETE50' },
  ],
  '2025-11-22': [
    { range: [1, 2], code: 'BLACKMLT' },
    { range: [3, 6], code: 'BLACKBIN' },
  ...
  '2025-11-26': [
    { range: [1, 3], code: 'BLACKMLT' },
    { range: [4, 9], code: 'BLACKBIN' },
    { range: [10, 15], code: 'BLACKCXA' },
    { range: [16, 21], code: 'BLACKSACOLA' },
    { range: [22, 23], code: 'BLACKFRETE50' },
  ],
  '2025-11-27': [
    { range: [1, 3], code: 'BLACKMLT' },
    { range: [4, 9], code: 'BLACKBIN' },
  ...
  '2025-11-29': [
    ...
    { range: [10, 15], code: 'BLACKCXA' },
    { range: [16, 21], code: 'BLACKSACOLA' },
    { range: [22, 25], code: 'BLACKFRETE50' },
  ],
  '2025-11-30': [
    { range: [1, 3], code: 'BLACKMLT' },
    { range: [4, 9], code: 'BLACKBIN' },
    { range: [10, 15], code: 'BLACKCXA' },
    { range: [16, 23], code: 'BLACKSACOLA' },
    { range: [24, 25], code: 'BLACKFRETE50' },
  ],
  ...
  //  const currentDate = '2025-11-10'; // força uma data que existe nas regras
    ...
    <div className={styles.roletaContainer} style={{ display: showRoletaContainer ? 'block' : 'none' }}>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.wheelContainer}>
          <img
            src="https://stermax.com.br/images_idealine/roleta-madu/pointer.webp"
            alt="Ponteiro"
